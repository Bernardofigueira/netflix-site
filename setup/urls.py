...
from clientes.views import Home,series,filmes,lancamentos,login,Cadastro,BuscaCliente,Logout,Listagem
...
urlpatterns = [
    ...
    path('cliente_tabela/', Listagem.as_view(), name="informacao"),
]
